...
(function () {
  ...
  function drawOrb(canvas, t, state) {
    ...
    for (let i = 0; i < 6; i++) {
      ...
      ctx.beginPath(); ctx.moveTo(0,0); ctx.lineTo(Math.cos(a)*hexR, Math.sin(a)*hexR);
