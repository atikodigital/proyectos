...
async function responderKaly(db, { companyId, employeeId = null, owner = null } = {}, messages, { gemini } = {}) {
  ...
  const systemPrompt = [
    ...
    'SIEMPRE define estado_pago: si el verbo indica pago ("pagué", "en efectivo", "con tarjeta") usa "pagada"; si es ambiguo ("gasté", "compré"), pregúntale "¿Ya lo pagaste?" antes de registrar y usa "pagada" o "pendiente" según responda.',
